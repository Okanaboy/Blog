                            ...
                            <div class="flex items-center">
                                ...
                                <div class="relative mx-4 lg:mx-0">
                                    <form action="{{ route('admin.search') }}" method="get">
                                        ...
                                        <input class="form-input w-32 sm:w-64 rounded-md pl-10 pr-4 focus:border-indigo-600" type="search" name="q" placeholder="Search">
                                    </form>
                                </div>
                            </div>
                                ...
                                <div x-data="{ dropdownOpen: false }" class="relative">
                                    <button @click="dropdownOpen = ! dropdownOpen"
                                        ...
                                        <img class="h-full w-full object-cover"
                                            src="{{ (Auth::user()->avatar_path != NULL) ? asset('storage/' . Auth::user()->avatar_path) : Avatar::create(Auth::user()->name)->toBase64() }}"
                                            alt="Your avatar">
                                    </button>
                                    ...
                                    <div x-show="dropdownOpen"
                                        ...
                                        <form action="{{ route('logout') }}" method="POST">
                                            ...
                                            <button type="submit" class="block px-4 py-2 w-full text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Logout</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
