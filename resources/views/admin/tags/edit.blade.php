<x-admin-layout>
    <div class="container mx-auto px-6 py-8">
        <h3 class="text-gray-700 text-3xl font-medium">Edit Tag</h3>
        <nav class="bg-grey-light rounded-md w-full my-5 ml-5 text-lg font-semibold">
            <ol class="list-reset flex">
              ...
              <li><a href="{{ route('admin.tags') }}" class="text-blue-600 hover:text-blue-700">Tag</a></li>
              <li><span class="text-gray-500 mx-2">></span></li>
                ...
                <div class="bg-gradient-to-b from-blue-800 to-blue-600 h-96"></div>
                    <div class="max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 mb-12">
                        <div class="bg-white w-full shadow rounded p-8 sm:p-12 -mt-72">
                            <p class="text-3xl font-bold leading-7 text-center">Edit this tag</p>
                            <form action="{{ route('tag.update', $tag) }}" method="post">
                                    ...
                                    <div class="md:flex items-center mt-8">
                                        <div class="w-full flex flex-col">
                                            ...
                                            <input type="text" name="name" value="{{ $tag->name }}" class="leading-none text-gray-900 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-100 border rounded border-gray-200"/>
                                        </div>
                                    </div>
